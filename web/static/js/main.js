...
var _user$project$Animations$shake___ = function (t) {
	return A2(
		...
		A2(
			...
			A2(
				...
				10,
				_mgold$elm_animation$Animation$animation(t))));
};
var _user$project$Animations$shake__ = function (t) {
	return A2(
		_mgold$elm_animation$Animation$duration,
		125 * _elm_lang$core$Time$millisecond,
		A2(
			_mgold$elm_animation$Animation$to,
			10,
			A2(
...
var _user$project$Animations$shake_ = function (t) {
	return A2(
		_mgold$elm_animation$Animation$duration,
...
var _user$project$Animations$shake = function (t) {
	return A2(
		_mgold$elm_animation$Animation$duration,
		125 * _elm_lang$core$Time$millisecond,
		A2(
...
var _user$project$Animations$animations = {
	ctor: '::',
	_0: _user$project$Animations$shake,
	_1: {
		ctor: '::',
		_0: _user$project$Animations$shake_,
		_1: {
			ctor: '::',
			_0: _user$project$Animations$shake__,
			_1: {
				ctor: '::',
				_0: _user$project$Animations$shake___,
				_1: {
					ctor: '::',
					_0: _user$project$Animations$shake,
					_1: {
...
var _user$project$Types$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {points: a, x: b, y: c, keyboardModel: d, clock: e, animation: f, animations: g, colour: h};
	});
var _user$project$Types$ChangeColor = function (a) {
	return {ctor: 'ChangeColor', _0: a};
};
var _user$project$Types$Shake = {ctor: 'Shake'};
var _user$project$Types$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Types$KeyboardExtraMsg = function (a) {
	return {ctor: 'KeyboardExtraMsg', _0: a};
};

var _user$project$View$drawLine = function (model) {
	var intsToFloats = function (_p0) {
		var _p1 = _p0;
		return {
			ctor: '_Tuple2',
	...
	var shape = _evancz$elm_graphics$Collage$path(
		A2(_elm_lang$core$List$map, intsToFloats, model.points));
	return A2(
		_evancz$elm_graphics$Collage$traced,
		_evancz$elm_graphics$Collage$solid(model.colour),
		shape);
};
var _user$project$View$colorBtn = function (label) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Types$ChangeColor(label)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$View$shakeBtn = A2(
	_elm_lang$html$Html$button,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$Shake),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Shake It Up!'),
		_1: {ctor: '[]'}
	});
var _user$project$View$view = function (model) {
	var angle = A2(_mgold$elm_animation$Animation$animate, model.clock, model.animation);
	return A2(
				...
				A3(
					...
					600,
					{
						...
						_0: A2(
							...
							_user$project$View$drawLine(model)),
						_1: {ctor: '[]'}
					})),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$shakeBtn,
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								...
								{
									ctor: '::',
									_0: _user$project$View$colorBtn('black'),
									_1: {
										ctor: '::',
										_0: _user$project$View$colorBtn('red'),
										_1: {
											ctor: '::',
											_0: _user$project$View$colorBtn('green'),
											_1: {
												ctor: '::',
												_0: _user$project$View$colorBtn('blue'),
												_1: {
													ctor: '::',
													_0: _user$project$View$colorBtn('yellow'),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$Main$getNextAnimation = function (model) {
	var _p0 = A2(_mgold$elm_animation$Animation$isDone, model.clock, model.animation);
	if (_p0 === true) {
		var nextAnimations = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			_elm_lang$core$List$tail(model.animations));
		var nextAnimation = function () {
			var _p1 = _elm_lang$core$List$head(model.animations);
			if (_p1.ctor === 'Nothing') {
				return _mgold$elm_animation$Animation$static(0);
			} else {
				return _p1._0(model.clock);
			}
		}();
		var justFinished = A2(
			_mgold$elm_animation$Animation$equals,
			nextAnimation,
			_mgold$elm_animation$Animation$static(0)) && (!A2(
			_mgold$elm_animation$Animation$equals,
			model.animation,
			_mgold$elm_animation$Animation$static(0)));
		var nextPoints = function () {
			var _p2 = justFinished;
			if (_p2 === true) {
				return {ctor: '[]'};
			} else {
				return model.points;
		...
		return {ctor: '_Tuple3', _0: nextPoints, _1: nextAnimation, _2: nextAnimations};
	} else {
		return {ctor: '_Tuple3', _0: model.points, _1: model.animation, _2: model.animations};
	}
};
var _user$project$Main$handleTick = F2(
	function (dt, model) {
		var _p3 = _user$project$Main$getNextAnimation(model);
		var points_ = _p3._0;
		var animation_ = _p3._1;
		var animations_ = _p3._2;
		var _p4 = _ohanhi$keyboard_extra$Keyboard_Extra$arrows(model.keyboardModel);
		var x = _p4.x;
		var y = _p4.y;
		var x_ = model.x + x;
		var y_ = model.y + y;
		var newPoints = function () {
			...
			if (((_p5.ctor === '_Tuple2') && (_p5._0 === 0)) && (_p5._1 === 0)) {
				return points_;
			} else {
				return {
					ctor: '::',
		...
		var _p6 = {ctor: '_Tuple2', _0: x, _1: y};
		if (((_p6.ctor === '_Tuple2') && (_p6._0 === 0)) && (_p6._1 === 0)) {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model_,
				{ctor: '[]'});
...
var _user$project$Main$selectColor = function (colour) {
	var _p7 = colour;
	switch (_p7) {
		case 'black':
	...
	function (msg, model) {
		...
		switch (_p8.ctor) {
			case 'KeyboardExtraMsg':
				var _p9 = A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, _p8._0, model.keyboardModel);
				var keyboardModel = _p9._0;
				var keyboardCmd = _p9._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{keyboardModel: keyboardModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Types$KeyboardExtraMsg, keyboardCmd)
				};
			case 'Tick':
				return A2(_user$project$Main$handleTick, _p8._0, model);
			case 'Shake':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{animations: _user$project$Animations$animations}),
					{ctor: '[]'});
			default:
				var colour_ = _user$project$Main$selectColor(_p8._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$init = function () {
	var _p10 = _ohanhi$keyboard_extra$Keyboard_Extra$init;
	...
	return {
		...
		_0: {
			...
			keyboardModel: keyboardModel,
			clock: 0,
			animation: _mgold$elm_animation$Animation$static(0),
			animations: {ctor: '[]'},
			colour: _elm_lang$core$Color$black
		},
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Types$KeyboardExtraMsg, keyboardCmd)
	};
}();
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$Types$KeyboardExtraMsg, _ohanhi$keyboard_extra$Keyboard_Extra$subscriptions),
			_1: {
				ctor: '::',
